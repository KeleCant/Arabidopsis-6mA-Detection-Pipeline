...
| [modbam2bed](https://github.com/epi2me-labs/modbam2bed) | modbam2bed converts modified BAM files to the .bed format for easier analysis of methylation marks. This tool will likely be replaced with [Modkit](https://github.com/nanoporetech/modkit/?tab=readme-ov-file) or a handwritten Python script. This program fails to generate 6mA scores properly causing IGV graphs to look corrupted. |
